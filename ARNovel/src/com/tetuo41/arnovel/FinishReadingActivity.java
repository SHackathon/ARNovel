...
* @version 1.0
*/
public class FinishReadingActivity extends Activity implements View.OnClickListener{

	/** カレントパッケージ名 */
	private static final String CURRENT_PACKAGE =
			FinishReadingActivity.class.getPackage().getName();
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.finish_reading);
    ...
    private void TopClick() {
    	...
    	try {
    		// TOPボタンクリック時、TOP画面へ遷移
    		// TODO TOP画面から読了画面に戻れないようにすべきか
    		Intent intent = new Intent();
    		intent.setClassName(CURRENT_PACKAGE, CURRENT_PACKAGE + ".TopActivity");
