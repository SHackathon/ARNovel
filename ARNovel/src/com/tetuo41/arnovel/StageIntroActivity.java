...
* @version 1.0
*/
public class StageIntroActivity extends Activity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.stage_intro);
    ...
    /**
     * ノベル画面ボタンクリック時の処理を記述する。
     */
    private void NextClick() {

    	try {
    		// ノベル画面ボタンクリック時、ノベル画面へ遷移
    		Intent intent = new Intent();
    		intent.setClassName(CURRENT_PACKAGE, CURRENT_PACKAGE + ".NovelActivity");
    		...
    		adb.setTitle("エラー");
    		adb.setMessage(cmndef.STAGE_INTRO_ERROR_MSG1);
