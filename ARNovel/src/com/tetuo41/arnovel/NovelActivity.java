...
public class NovelActivity extends Activity implements View.OnClickListener{
	...
	private static final String CURRENT_PACKAGE =
			NovelActivity.class.getPackage().getName();
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		// ClickListener登録
		findViewById(R.id.finish_reading).setOnClickListener(this);
     ...
     * 読了ボタンクリック時の処理を記述する。
     */
    private void FinishReadingClick() {

    	try {
    		// 読了ボタンクリック時、読了画面へ遷移
    		Intent intent = new Intent();
    		intent.setClassName(CURRENT_PACKAGE, CURRENT_PACKAGE + ".FinishReadingActivity");
    		...
    		adb.setTitle("エラー");
    		adb.setMessage(cmndef.NOVEL_ERROR_MSG1);
